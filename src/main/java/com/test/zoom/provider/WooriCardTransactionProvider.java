...
import com.test.zoom.repository.card.SSCardRepository;
import com.test.zoom.repository.card.WOCardRepository;
...
public class WooriCardTransactionProvider implements CardTransactionProvider {

    private final WOCardRepository repository;
