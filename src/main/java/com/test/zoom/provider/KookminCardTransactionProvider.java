...
import com.test.zoom.repository.card.KBCardRepository;
...
public class KookminCardTransactionProvider implements CardTransactionProvider {

    private final KBCardRepository repository;
