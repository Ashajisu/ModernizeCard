...
import com.test.zoom.repository.card.HDCardRepository;
...
public class HyndayCardTransactionProvider implements CardTransactionProvider {

    private final HDCardRepository repository;
